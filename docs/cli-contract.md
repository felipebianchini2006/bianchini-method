...
| `learn.propose` | core_0_4 | JSON object indentado, chaves ordenadas, UTF-8 e newline final | 0, 2, 3, 4 | .bianchini/.runtime/learning/pending/** | propose_learning | skills/_shared/scripts/bm_learning.py | — | tests/test_learning.py::test_cli_exposes_opt_in_propose_list_approve_reject_and_deactivate |
